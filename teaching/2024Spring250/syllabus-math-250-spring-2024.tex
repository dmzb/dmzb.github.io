...
\textbf{Instructor:} & David Zureick-Brown (``DZB'') & & & & \textbf{Office:} & 502 Seeley Mudd \\
 ...
 \textbf{Time:} & TuTh 11:30 -- 1:00  & & & & &Wednesdays 2:30-3:30 (via zoom) \\
...
\textbf{Math Fellows:} & David Metacarpa & \href{mailto: dmetacarpa24@amherst.edu}{dmetacarpa24@amherst.edu} & TBA &7-7:30 & TBA & 6-7:30 \\
 & &   & SM & TBA & SM & TBA\\ 
...
\noindent\textbf{Prerequisites:} Instructor permission. \textbf{todo}
\smallskip
% \vspace*{.15in}
% \noindent\rule{18cm}{0.4pt}
% \vspace*{.15in}

\noindent \textbf{Course content}: We will cover some subset of the following topics: unique factorization, irrational numbers, residue systems, congruences, primitive roots, reciprocity laws, quadratic forms, arithmetic functions, partitions, Diophantine equations, distribution of primes.
...
\begin{center}
 ...
 Midterm 1 & Thursday, ??? \\
 Midterm 2 & Thursday, ??? \\ 
   Final Exam & Monday, May ???, ???-5pm in the usual room (SMUD 014)	 \\
