...
\setlength{\evensidemargin}{-.5in} \setlength{\oddsidemargin}{-.5in}
\setlength{\topmargin}{-.5in} \setlength{\textwidth}{7in}
...
\ques{10}   Label each of the following functions as injective, surjective, 
...
\newpage
\ques{15}  Let $f\colon A \to B$ and $g \colon B \to C$ be
  functions. 
  % \begin{enumerate}
  % \item Prove that if $f$ and $g$ are injective, then $g\circ f$ is injective.
  % \item State and prove or disprove the converse.
  %  \end{enumerate}

  %  Let $f\colon A \to B$ and $g \colon B \to C$ be
  % functions. 
  \begin{enumerate}
  % \item Prove that  if $f$ and $g$ are injective, then $g\circ f$ is injective.
  % \item State and prove or disprove the converse.
  ...
  \item Prove or disprove the converse. (For disproofs, please also give a counterexample.)
...
\newpage \ques{10} Let $f\colon A \to B$ be a function and let $X,Y \subseteq B$. Prove that if $f$ is surjective then $f^{-1}(X) \subseteq f^{-1}(Y) \Rightarrow X \subseteq Y$.
...
\newpage 
\ques{15} Define a relation $R$ on the set
% $\mathbb{Z}$ as follows: we say that $x \sim y$ if $x \leq y^2$.
$\mathbb{R}$ as follows: we say that $x \sim y$ if $x \leq y-1$.
Prove or disprove each of the following. (For disproofs, please also give a counterexample.)
 \begin{enumerate}
 \item $R$ is reflexive.
 \item $R$ is symmetric.
...
\begin{multicols}{2}
\scriptsize{\noindent {\sc David Zureick-Brown, Instructor}\\
        ...
        Math 250 $\sim$ Foundations of Math \\
        Emory University\\
        Dept. of Mathematics\\
        Spring 2022\\[20pt]
        \end{flushright}}
...
\begin{itemize}
\item No calculators or extraneous scratch paper please!
\item If you need more scratch paper, please raise your hand.
