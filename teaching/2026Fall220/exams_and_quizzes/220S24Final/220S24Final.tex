...
\newcommand{\midtermOrFinal}  {Final Exam}
...
\item I will be in the hallway, and will check every half hour for questions.  
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\ques{5} Let $f \colon A \to B$ be a function.
...
Negate the definition of surjective.\\
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\ques{20} Let $f \colon A \to B$ be a function and let $X \subset
A$. Prove or disprove each of the following. (One is true and one is false. For disproofs, please also give a counterexample.)
\begin{enumerate}
  \item $X \subseteq f^{-1}(f(X))$.
  \item $X \supseteq f^{-1}(f(X))$.
  \end{enumerate}

%   Let $f \colon A \to B$ be a function and let $W \subset
...
% \newpage
% \begin{center}{\tiny{(This page is intentionally blank; feel free to use it for scratch work)}}\end{center}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 

\ques{10}
Let $f\colon A \to B$ be a function and let $X,Y \subset
  B$. Prove that $$f^{-1}(X) \cap f^{-1}(Y) \subseteq f^{-1}(X \cap Y)^{-1}.$$
% Let $f\colon A \to B$ be a function and let $X,Y \subset
%   A$. Prove that if $f$ is injective then $f(X) \cap f(Y) \subseteq f(X \cap Y)$.
...
% Answers (please circle). No justification necessary.\vspace{.3cm}
% \begin{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ques{10}
Let $A$ and $B$ be sets. Prove that $(A \cup B) \cap \overline{A} \subset B - A$.
...
Prove that $f$ is surjective. (Do not use the ``invertible if and only if bijective'' theorem.)

\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ques{10} Let $a_n$ be defined recursively by $a_1 = 1$ and $a_n = \sqrt{1 + a_{n-1}}$. Prove that for all positive integers $n$, $a_n < 2$.
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ques{10} Prove that $\sqrt{2}$ is irrational.
