...
\fakesectionnocounter{(On \csname midterm1Date\endcsname):  Midterm 1}  \input{assignments-source/S24-220M1.tex} \newpage
...
\fakesectionnocounter{(On \csname midterm2Date\endcsname):  Midterm 2}  \input{assignments-source/S24-220M2.tex} \newpage
