...
\thispagestyle{plain}
\begin{center}
  {\Large Math 220-02: Mathematical Reasoning and Proof \\ Instructor: David Zureick-Brown (``DZB'')\smallskip}
\end{center}
\vskip-.05in
...
\newpage      
\fakesection{(due \csname dateWeek1\endcsname):  \csname topic1\endcsname} \input{assignments-source/S24-220HW1.tex} \newpage 
\fakesection{(due \csname dateWeek2\endcsname):  \csname topic2\endcsname} \input{assignments-source/S24-220HW2.tex} \newpage
\fakesection{(due \csname dateWeek3\endcsname):  \csname topic3\endcsname} \input{assignments-source/S24-220HW3.tex} \newpage
\fakesection{(due \csname dateWeek4\endcsname):  \csname topic4\endcsname} \input{assignments-source/S24-220HW4.tex} \newpage
\fakesection{(due \csname dateWeek5\endcsname):  \csname topic5\endcsname} \input{assignments-source/S24-220HW5.tex} \newpage
\fakesectionnocounter{(On \csname dateWeek5\endcsname):  Midterm 1}  \input{assignments-source/S24-220M1.tex} \newpage
\fakesection{(due \csname dateWeek6\endcsname):  \csname topic6\endcsname} \input{assignments-source/S24-220HW6.tex} \newpage
\fakesection{(due \csname dateWeek7\endcsname):  \csname topic7\endcsname}  \input{assignments-source/S24-220HW7.tex} \newpage
\fakesection{(due \csname dateWeek8\endcsname):  \csname topic8\endcsname}  \input{assignments-source/S24-220HW8.tex} \newpage
\fakesection{(due \csname dateWeek9\endcsname):  \csname topic9\endcsname}  \input{assignments-source/S24-220HW9.tex} \newpage
\fakesectionnocounter{(On \csname dateWeek9\endcsname):  Midterm 2}  \input{assignments-source/S24-220M2.tex} \newpage
\fakesection{(due \csname dateWeek10\endcsname): \csname topic10\endcsname} \input{assignments-source/S24-220HW10.tex} \newpage
\fakesection{(due \csname dateWeek11\endcsname): \csname topic11\endcsname} \input{assignments-source/S24-220HW11.tex} \newpage
\fakesection{(due \csname dateWeek12\endcsname): \csname topic12\endcsname} \input{assignments-source/S24-220HW12.tex} \newpage
\fakesection{(Not due): \csname topic13\endcsname} \smallskip \input{assignments-source/S24-220HW13.tex} \newpage
\fakesectionnocounter{(On \csname finalDate\endcsname):    Final Exam}  \input{assignments-source/S24-220F.tex} \newpage
