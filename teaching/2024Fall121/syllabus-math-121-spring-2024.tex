...
\textbf{Instructor:} & David Zureick-Brown (``DZB'') & & & & \textbf{Office} & 502 Seeley Mudd \\
 \textbf{Email:} & \href{mailto: dzureickbrown@amherst.edu}{dzureickbrown@amherst.edu} & & & & \textbf{Hours:} & TBA\\
 \textbf{Time:} & TuTh 1 -- 2:15  & & & & &TBA\\
 \textbf{Place:} & TBA & & & & & TBA
% & Mondays 4:15-5:15 (in person)\\
%  \textbf{Time:} & TuTh 1:30 -- 12:45  & & & & &Wednesdays 2:30-3:30 (via zoom) \\
...
\href{https://link.springer.com/book/10.1007/978-0-387-79711-3}
{``Combinatorics and Graph Theory"} 2nd ed., by John Harris, Jeffry Hirst, Michael Mossinghoff
\medskip



\noindent\textbf{Course website:} \url{https://dmzb.github.io/teaching/2024Fall280/}
\medskip
...
\textbf{Math Fellow(s):} & Claire Callon & \href{mailto: ccallon25@amherst.edu}{ccallon25@amherst.edu}  
  & TBA &TBA & TBA & TBA \\
 & &   & TBA & TBA & TBA & TBA\\ 
...
\noindent\textbf{Prerequisites:} Math 271 or 272 or instructor consent. Math 220 or other prior experience with mathematical proofs is recommended. 
...
% \item[] {\bf The QCenter:} \textbf{Allison Tanguay} of the the Moss Quantitative Center offers Math~280 help, including both appointments and unscheduled drop-ins.
...
\begin{center}
 \url{https://dmzb.github.io/teaching/2024Fall280/assignments-F24-280.pdf}
\end{center}
...
\begin{center}
 ...
 \hline
 2 midterms and a comprehensive final exam & $70\% = $ 	 \\
 Best exam & $30\% + $ 	 \\
 Second best exam& $25\% + $ 	 \\
 Third best exam & $15\% + $ 	 \\
 \hline
...
\begin{center}
 ...
 \hline
 Midterm 1 & Thursday?, October ?? (TBA) \\
 Midterm 2 & Tuesday?, November ?? (TBA) \\
   % Final Exam & Monday, May 13, 9-11 in the usual room (TBA)	 \\
