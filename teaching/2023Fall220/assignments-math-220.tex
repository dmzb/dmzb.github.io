...
%***************************************************************************************************************
\newpage
\section[1 (due \csname dateWeek1\endcsname): Introduction to course. Mathematical reasoning.]{Assignment 1}
...
% %***************************************************************************************************************
% \newpage
% \section[2 (due \csname dateWeek2\endcsname): Divisibility problems and ``direct'' proofs.]{Assignment 2}
...
% \noindent \textbf{Assignment, due Friday, \csname dateWeek3\endcsname, via Gradescope}:
% \begin{enumerate}
...
% \noindent \textbf{Assignment, due Friday, \csname dateWeek4\endcsname, via Gradescope}:
% \begin{enumerate}
...
% \noindent \textbf{Assignment 7, due Thursday, \csname dateWeek7\endcsname, via Gradescope}:
...
% \noindent \textbf{Assignment 8, due Friday, \csname dateWeek8\endcsname, via Gradescope}:
% \begin{enumerate}
...
% \noindent \textbf{Assignment 9, due Friday, \csname dateWeek9\endcsname, via Gradescope}:
% \begin{enumerate}
...
% \noindent \textbf{Assignment 10, due Friday, \csname dateWeek10\endcsname, via Gradescope}:
% \begin{enumerate}
...
% \noindent \textbf{Assignment 11, due Friday, \csname dateWeek11\endcsname, via Gradescope}:
% \begin{enumerate}
...
% \noindent \textbf{Assignment 12, due Thursday, \csname dateWeek12\endcsname, via Gradescope}:
% \begin{enumerate}
