...
\noindent \textbf{Assignment, due Friday, \csname dateWeek3\endcsname, \HWdueTime via Gradescope TODO}:
\begin{enumerate}
...
% \noindent \textbf{Assignment 7, due Thursday, \csname dateWeek7\endcsname, \HWdueTime via Gradescope TODO}:
...
% \noindent \textbf{Assignment 12, due Thursday, \csname dateWeek12\endcsname, \HWdueTime via Gradescope TODO}:
% \begin{enumerate}
