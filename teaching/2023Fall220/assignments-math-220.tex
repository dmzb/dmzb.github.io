...
\noindent \textbf{Assignment 13, not to be handed in}: one or two problems from this assignment might appear verbatim on the final. There would not be time for the graders to grade this assignment before the final; so instead, I am happy to explain in full detail how to do any problem from this assignment.
