...
\stepcounter{pubs} \arabic{pubs}.  \textbf{A predicted distribution for Galois groups of maximal unramified extensions}, with Yuan Liu and Melanie Matchett Wood; accepted for publication in Inventiones mathematicae
...
\stepcounter{pubs} \arabic{pubs}.  \textbf{Arithmetic irrationality of del Pezzo surfaces}, with Adam Logan, Anthony V\'arilly-Alvarado; submitted, and will appear on arxiv soon

\stepcounter{pubs} \arabic{pubs}.  \textbf{Wild Stacky Curves and Rings of Mod $p$ Modular Forms}\\
with Andrew Kobin, \href{http://arxiv.org/abs/2510.08821}{arxiv 2510.08821}

\stepcounter{pubs} \arabic{pubs}.  \textbf{The Jacobi Bound Conjecture for Generically Reduced Differential Schemes}\\
with Taylor Dupuy, \href{https://arxiv.org/abs/2603.17991}{arxiv 2603.17991}

\stepcounter{pubs} \arabic{pubs}.  \textbf{The Dimension Conjecture implies The Jacobi Bound Conjecture}\\
with Taylor Dupuy, \href{https://arxiv.org/abs/2603.17992}{arxiv 2603.17992}

\stepcounter{pubs} \arabic{pubs}.  \textbf{Abelian Chabauty}\\
Notes from my 2020 Arizona Winter School lectures; submitted
...
\begin{tabular}{rlll}
 Fall 2026 & \defi{Calculus with Algebra} & Math 105\\  
 Fall 2026 & \defi{Mathematical Reasoning and Proof} & Math 220\\  
...
\begin{tabular}{lll}
  ...
  & & Currently: Faculty at University of North Texas
\end{tabular}
...
\begin{tabular}{lll}
  % (2026) & \defi{Osha Jones} & ``\emph{Local to global problems about elliptic curves}''\\
  (2026) & \defi{Ata Sevgi} & ``\emph{Representation theory and physics (tentative title)}''\\    
  (2025) & \defi{Osha Jones} & ``\emph{Local to global problems about elliptic curves}''\\
...
\begin{tabular}{llll}
(2026) & Seong Eun Jung & Advisor:  Paul Gunnells & (UMass Amherst)\\      
...
\begin{tabular}{ll}
  (Spring 2026-present) & Advisory board   \\
  (Fall 2014-2025) & Organizer (PI)\\  
...
\textbf{Panelist} for the National Science Foundation (2016/19/24).
...
\begin{tabular}{rl}
(2026) & European Research Council\\
(2020) & The Royal Society (UK)  \\
(2018) & Netherlands Organisation for Scientific Research\\
(2017/24) & Israel Science Foundation \\
...
(2026 Summer) \textbf{Mazur's Program B, after Furio--Lombardo};\\
ChaBONNty conference, at Bonn
\vspace{.05cm}\\ 
(2026 Spring) \textbf{$\ell$-adic images of Galois for elliptic curves over $\mathbb{Q}$};\\
Seminar talk at University of Western Ontario
\vspace{.05cm}\\  
(2026 Spring) \textbf{Angle ranks of abelian varieties};\\
Seminar talk at Boston University Number Theory Seminar
\vspace{.05cm}\\    
(2026 Spring) \textbf{Angle ranks of abelian varieties};\\
Seminar talk at Clemson University
\vspace{.05cm}\\  
(2026 Spring) \textbf{Angle ranks of abelian varieties};\\
Invited talk at ALLADI70.
\vspace{.05cm}\\ 
(2026 Spring) \textbf{Beyond Fermat's last theorem}\\
Colloquium at University of North Texas
\vspace{.05cm}\\    
(2026 Spring) \textbf{$\ell$-adic images of Galois for elliptic curves over $\mathbb{Q}$};\\
Seminar talk at the Harvard number theory seminar
\vspace{.05cm}\\  
(2026 Spring) \textbf{Angle ranks of abelian varieties};\\
Seminar talk at the MIT number theory seminar
\vspace{.05cm}\\
(2026 Spring) \textbf{Beyond Fermat's last theorem}\\
Colloquium at Wesleyan
\vspace{.05cm}\\
(2026 Winter) \textbf{The Arithmetic of Stacks}\\
Banff
\vspace{.05cm}\\  
(2025 Fall) \textbf{$\ell$-adic images of Galois for elliptic curves over $\mathbb{Q}$};
Seminar talk at University of French Polynesia
\vspace{.05cm}\\
